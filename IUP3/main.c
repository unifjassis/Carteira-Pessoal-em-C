...
int main(int argc, char **argv)
{
  ...
  *sub1_menu, *menu, *label;
  ...
  label = IupLabel("Bem vindo a sua carteira pessoal.");
  ...
  IupSetAttribute(label, "FONTSIZE", "23");
